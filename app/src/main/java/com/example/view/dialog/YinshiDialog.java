...
public class YinshiDialog {
	...
	public YinshiDialog(Context context) {
		...
		window.setContentView(R.layout.yinshi_alert_msg);
    ...
    public YinshiDialog(Context context, boolean b) {
        this.context=context;
        ad=new android.app.AlertDialog.Builder(context,R.style.CommunalDialog).create();
		ad.setCancelable(false);
        ad.show();
	...
	public YinshiDialog(Context context, String str, String color, int layout, int txtid) {
		this.context=context;
...
//			Toast.makeText(context, "点击提示框外部可关闭", 200).show();
	...
	{
		messageView.setMovementMethod(method);
	}*/
	public void show(){
		ad.show();
	}
