 ...
 * @author Jeff Gilfelt
 */
public class MBadgeView extends TextView {
     ...
     */
    public MBadgeView(Context context, View target) {
     ...
     */
    public MBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public MBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public MBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            Log.e("viewCount",container.getChildCount()+"");
    ...
    private void show(boolean animate, Animation anim) {
        if (getBackground() == null) {
            ...
            Drawable drawable = getResources().getDrawable(R.drawable.u33);//自定义图片
