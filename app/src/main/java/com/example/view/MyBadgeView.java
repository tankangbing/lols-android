...
public class MyBadgeView extends TextView {
     ...
     */
	public MyBadgeView(Context context, TabWidget target, int index) {
	...
	public MyBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
	...
	private void show(boolean animate, Animation anim) {
		if (getBackground() == null) {
			...
			Drawable drawable = getResources().getDrawable(R.drawable.icon_star1);//���� ��ɫ
